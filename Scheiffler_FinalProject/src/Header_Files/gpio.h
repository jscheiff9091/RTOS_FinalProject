...
#define TIRE_SLIP_WARN_CLR			(1 << 1u)
#define TIRE_OFF_ROAD				(1 << 2u)
#define VEH_HEAD_WARN				(1 << 3u)
#define VEH_HEAD_WARN_CLR			(1 << 4u)
#define VEH_OFF_ROAD				(1 << 5u)
#define TOGGLE_WARN_LED				(1 << 6u)
#define LED_WARN_ANY				(TIRE_SLIP_WARN | TIRE_OFF_ROAD | VEH_HEAD_WARN | VEH_OFF_ROAD | TOGGLE_WARN_LED)
#define ANY_EX_HEAD					(TIRE_SLIP_WARN | TIRE_OFF_ROAD | VEH_HEAD_WARN_CLR | VEH_OFF_ROAD | TOGGLE_WARN_LED)
#define ANY_EX_SLIP					(TIRE_SLIP_WARN_CLR | TIRE_OFF_ROAD | VEH_HEAD_WARN | VEH_OFF_ROAD | TOGGLE_WARN_LED)
#define ANY_EX_WARN					(TIRE_SLIP_WARN_CLR | TIRE_OFF_ROAD | VEH_HEAD_WARN_CLR | VEH_OFF_ROAD | TOGGLE_WARN_LED)
#define LED_FLAGS_ALL				(TIRE_SLIP_WARN | TIRE_SLIP_WARN_CLR | TIRE_OFF_ROAD | VEH_HEAD_WARN | VEH_HEAD_WARN_CLR | VEH_OFF_ROAD | TOGGLE_WARN_LED)
#define TOGGLE_TIMEOUT				5u
